...
pub fn populate_demo(app: &mut App) {
    ...
    app.sessions = vec![
        ...
        AgentSession {
            ...
            first_assistant_text: String::new(),
            initial_prompt: "Refactor the pi extension loader to use the new resource resolver".into(),
            tool_calls: vec![],
            pending_since_ms: 0,
            thinking_since_ms: 0,
            file_accesses: vec![],
        ...
        AgentSession {
            agent_cli: "kiro",
            pid: 10200,
            session_id: "01HKIRO000000000000000A".into(),
            cwd: "/Users/demo/kiro-playground".into(),
            project_name: "kiro-playground".into(),
            started_at: now - 12 * 60 * 1000,
            status: SessionStatus::Executing,
            model: "CLAUDE_SONNET_4_5_20250929_V1_0".into(),
            effort: String::new(),
            // Kiro persists token counts as 0; credits are routed into
            // total_input_tokens as (credits * 100). 115.3cr shown as 11_530.
            context_percent: 37.0,
            total_input_tokens: 11_530,
            total_output_tokens: 0,
            total_cache_read: 0,
            total_cache_create: 0,
            turn_count: 6,
            current_tasks: vec!["Running kiro-cli-chat".into()],
            mem_mb: 96,
            version: String::new(),
            git_branch: "main".into(),
            git_added: 0,
            git_modified: 2,
            token_history: vec![500, 1200, 2100, 3200, 8400, 11_530],
            context_history: vec![],
            compaction_count: 0,
            context_window: 200_000,
            subagents: vec![],
            ...
            children: vec![],
            first_assistant_text: String::new(),
            initial_prompt: "Run the kiro stress test suite".into(),
            tool_calls: vec![],
            pending_since_ms: 0,
            thinking_since_ms: 0,
            file_accesses: vec![],
        ...
        AgentSession {
            agent_cli: "opencode",
            pid: 9500,
            session_id: "ses_a7b8c9d0-1234-5678-9abc-777777777777".into(),
            cwd: "/Users/demo/infra".into(),
            project_name: "infra".into(),
            started_at: now - 8 * 60 * 1000,
            status: SessionStatus::Executing,
            ...
            git_added: 1,
            git_modified: 3,
            token_history: vec![3000, 5000, 8000, 6000, 9000, 7000, 11000, 8000, 10000],
            context_history: vec![],
            compaction_count: 0,
